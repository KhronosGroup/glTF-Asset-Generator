    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            foreach (var test in testBatch)
            {
                ...
                mdLogHeader = "The first table contains attributes that are explicitly set in every model generated by this test. The second table contains a grid showing which attributes are being set for a given model.";
