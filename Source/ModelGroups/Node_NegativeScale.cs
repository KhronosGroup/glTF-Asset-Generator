    ...
    internal class Node_NegativeScale : ModelGroup
    {
        ...
        public Node_NegativeScale(List<string> imageList)
        {
            ...
            Model CreateModel(Action<List<Property>, Runtime.Node, Runtime.Node> setProperties)
            {
                ...
                {
                    gltf.Scenes.ElementAt(0).Nodes[0],
                    gltf.Scenes.ElementAt(0).Nodes[0].Children[0],
                };
            ...
            void SetVertexNormal(List<Property> properties, Runtime.Node nodeZero, Runtime.Node nodeOne)
            {
                ...
                var meshPrimitive0 = nodeZero.Mesh.MeshPrimitives.ElementAt(0);
                var meshPrimitive1 = nodeOne.Mesh.MeshPrimitives.ElementAt(0);
                Runtime.MeshPrimitive.SetVertexProperties(meshPrimitive0.Vertices, normals, (vertex, normal) =>
                {
                    vertex.Normal = normal;
                });
                Runtime.MeshPrimitive.SetVertexProperties(meshPrimitive1.Vertices, normals, (vertex, normal) =>
                {
                    vertex.Normal = normal;
                });
            ...
            void SetVertexTangent(List<Property> properties, Runtime.Node nodeZero, Runtime.Node nodeOne)
            {
                ...
                var meshPrimitive0 = nodeZero.Mesh.MeshPrimitives.ElementAt(0);
                var meshPrimitive1 = nodeOne.Mesh.MeshPrimitives.ElementAt(0);
                Runtime.MeshPrimitive.SetVertexProperties(meshPrimitive0.Vertices, tangents, (vertex, tangent) =>
                {
                    vertex.Tangent = tangent;
                });
                Runtime.MeshPrimitive.SetVertexProperties(meshPrimitive1.Vertices, tangents, (vertex, tangent) =>
                {
                    vertex.Tangent = tangent;
                });
