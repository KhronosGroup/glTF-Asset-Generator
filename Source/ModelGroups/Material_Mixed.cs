    ...
    internal class Material_Mixed : ModelGroup
    {
        ...
        public Material_Mixed(List<string> imageList)
        {
            ...
            Model CreateModel(Action<List<Property>, Runtime.Material, Runtime.Material> setProperties)
            {
                ...
                var extensions = new List<Runtime.Extensions.Extension>();
            ...
            void SetSpecularGlossiness0(List<Property> properties, Runtime.Material material0, Runtime.Material material1)
            {
            ...
            void SetSpecularGlossiness1(List<Property> properties, Runtime.Material material0, Runtime.Material material1)
            {
            ...
            this.Models = new List<Model>
            {
                CreateModel((properties, material0, material1) => {
                    SetSpecularGlossiness0(properties, material0, material1);
                    SetSpecularGlossiness1(properties, material0, material1);
                }),
                CreateModel((properties, material0, material1) => {
