...
namespace AssetGenerator.Runtime
{
    public class MaterialSpecularGlossiness
    {
        ...
        public glTFLoader.Schema.Extension ConvertToMaterialSpecularGlossinessExtension(List<glTFLoader.Schema.Sampler> samplers, List<glTFLoader.Schema.Image> images, List<glTFLoader.Schema.Texture> textures, List<glTFLoader.Schema.Texture> material)
        {
