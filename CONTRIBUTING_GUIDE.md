...
+ Aim to have less than thirteen models and less than about six properties being tested in a single model group.
...
3. Delete undesired models and screenshots from the Output folder. (Files will be overwritten, but not deleted) 
...
Running the PowerShell script `SampleImageHelper.ps1` results in the ScreenshotGenerator using the manifest to create screenshots of the models.
